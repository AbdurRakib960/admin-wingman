        ...
        <div className="w-[100%] bg-[#EFF3FB] px-[10px] flex justify-center items-center bg-surface-muted h-screen">
            ...
            >
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="w-[100%] mt-2 h-[48px] xl:h-[56px] text-[16px] font-bold cursor-pointer rounded-[6px] bg-primary hover:bg-[#BB2146] transition-all duration-200 text-[#FFFFFF]"
                    >
                        {buttonLoading ? (
...
const RememberCheckbox = ({ remember, setRemember }: RCTYPE) => {
    return (
        ...
        >
            <div
                className={`w-[14px] h-[14px] border rounded-sm border-[#333] flex justify-center items-center ${remember && "!border-primary bg-primary"
                    }`}
            >
