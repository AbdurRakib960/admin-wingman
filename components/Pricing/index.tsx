    ...
    if (!data) {
        return isLoading ? (
            <div className="flex items-center justify-center w-full h-screen">
                <LoadingAnimation color="#F92C5D" width={50} height={50} />
            </div>
        ) : (
            <div className="flex items-center justify-center w-full h-screen">
                ...
                <div>
                    <div className="flex flex-col justify-center gap-6 lg:flex-row lg:flex-wrap">
                        {data.map((v, i) => (
                            <div
                                key={i}
                                className="pricing-shadow h-auto p-[16px] xl:w-[384px] lg:p-4 w-[100%] xs:w-[343px] lg:w-[238px]  xl:pt-[40px] xl:pb-[40px] 2xl:px-[24px] bg-white group  transition-all duration-200  rounded-[6px] border border-[rgba(255,255,255,0.21)]"
                            >
                                <PricingCard
                                    interval={interval}
                                    data={v}
