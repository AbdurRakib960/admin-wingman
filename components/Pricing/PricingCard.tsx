...
function PricingCard({
    ...
    return (
        <div className="">
            ...
            <p
                className="leading-[30px] xs:mb-[14px] group-hover:text-white text-text-primary lg:text-[18px] 2xl:text-[32px] font-[600] xs:text-[12px] 2xl:my-[20px]
                                 lg:my-[4px]"
            >
                ${data.price[interval]}{" "}
            ...
            <Link href={`/pricing/edit/${data._id}?interval=${interval}`}>
                <button className="rounded-[4px] xs:mb-[14px] bg-white border-[#FFF] border-[1px] font-[500]  text-[14px] w-full mt-2 lg:mb-3 2xl:mb-7 text-[white] hover:bg-primary hover:border-primary py-3">
                    Edit
                </button>
            </Link>
                    ...
                    <div key={i}>
                        <li className="flex items-center justify-start gap-2 lg:gap-4">
                            <img
                                ...
                                alt=""
                            />
                            <span className="leading-[22px] text-[14px] group-hover:text-white text-text-primary xs:leading-[18px] ">
                                {feature.text}
                            </span>
                        </li>
                    </div>
