    ...
    return (
        <div className="bg-white p-6 rounded-[6px]">
            <div className="flex justify-between w-full mb-[21px]">
                <p className="lg:text-[22px] xs:text-[16px] font-[500] text-text-primary mb-2">
                    Add offer
                </p>
                <button
                    type="button"
                    disabled={!!!offerText}
                    className="px-3 py-2 disabled:opacity-60 rounded-[8px] bg-primary enabled:hover:bg-[#BB2146] transition-all duration-200 flex justify-center items-center gap-[11.33px] text-[14px] text-[white] font-semibold"
                    onClick={() => {
