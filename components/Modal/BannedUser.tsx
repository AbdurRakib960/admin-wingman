    ...
    >
      <div className="p-[20px] sm:p-[32px]">
        ...
        <p className="text-[14px] max-w-[373px] leading-[22px] mb-[32px] font-normal text-[#6B7280]">
          {data?.status === "banned" ? "When the user is ban, he will  be able to use wingmanAI's services" : "When the user is ban, he will no longer be able to use wingmanAI's services"}
        </p>
