    ...
    >
      <div className="p-[20px] sm:p-[32px]">
        ...
        <div className="flex gap-[24px] justify-end">
          <button onClick={handleModal} className="w-[110px] h-[44px] sm:w-[150px] sm:h-[48px] text-[14px] font-medium hover:bg-[#c0baf7] hover:text-primary bg-[#E3E0FE] text-primary border border-[#E3E0FE] rounded-[6px] transition-all duration-100">
            Cancel
          </button>
          <button className="w-[110px] h-[44px] sm:w-[150px] sm:h-[48px] text-[14px] font-medium hover:bg-[#8076f5] bg-primary text-[#FFFFFF] rounded-[6px] transition-all duration-100">
