        ...
        <div className={props.className}>
            ...
            <div className="relative">
                <input
                    ...
                    className={` ${meta.touched && meta.error && "!border-error"
                        } rounded-[6px] mb-[24px] w-full h-[48px] bg-[#F1F0FF] text-[#252C48] placeholder:text-[#252C48] placeholder:font-[400] placeholder:text-[14px] text-[14px] font-[400] px-4 py-3 border-[#E3E0FE] border-[1px] focus:outline-none  ${props.inputClass
