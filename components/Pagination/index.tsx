        ...
        <>
            ...
            {dataArr.length > itemsPerPage && (
                <ReactPaginate
                    ...
                    disabledClassName="!bg-[#C8CBD0] !text-[#2E3134] p-[2px_8px] rounded-[3px]"
                    nextClassName="bg-[#F92C5D] text-[#fff] p-[2px_8px] rounded-[3px]"
                    previousClassName="bg-[#F92C5D] text-[#fff] p-[2px_8px] rounded-[3px]"
                    pageCount={pageCount}
                    marginPagesDisplayed={1}
                    previousLabel="Previous"
                    activeClassName="bg-[#F92C5D] text-[#fff] p-[2px_8px] rounded-[3px]"
                />
            )}
        </>
    );
